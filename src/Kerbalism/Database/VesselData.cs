...
namespace KERBALISM
{
	public class VesselData
	{
		...
		private void EvaluateStatus()
		{
			...
			evas = (uint)(Math.Max(0, ResourceCache.GetResource(Vessel, "Nitrogen").Amount + ResourceCache.GetResource(Vessel, "Atmosphere").Amount - 330) / Settings.LifeSupportAtmoLoss);
